package pain_008_001_08_to_stin_st_001_cbisdd_reqmsg
...
type ConvOptions struct {
	inputAdapter  pain_008_001_08.DocumentAdapter
	outputAdapter stin_st_001_cbisdd_reqmsg.DocumentAdapter
}

type ConvOption func(opts *ConvOptions)

func WithInputAdapter(adapter pain_008_001_08.DocumentAdapter) ConvOption {
...
func Conv(in *pain_008_001_08.Document, opts ...ConvOption) (*stin_st_001_cbisdd_reqmsg.Document, error) {

	const semLogContext = "pain-008-001-08-to-stin-st-001_cbi-sdd-req-msg::conv"
...
func XMLDataConv(painData []byte, opts ...ConvOption) ([]byte, error) {
	...
	const semLogContext = "pain-008-001-08-to-stin-st-001_cbi-sdd-req-msg::xml-data-conv"

	pain, err := pain_008_001_08.NewDocumentFromXML(painData)
	if err != nil {
...
func XMLFileConv(inFn string, outFn string, opts ...ConvOption) error {
	...
	const semLogContext = "pain-008-001-08-to-stin-st-001_cbi-sdd-req-msg::xml-file-conv"
