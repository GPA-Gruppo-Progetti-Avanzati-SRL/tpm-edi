package stin_st_003_cbi_sdd_sts_rpt_msg_to_pain_002_001_10

import (
	"fmt"
	"github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-edi-cbi/cbi/stin_mo_001/stin_mo_001_00_01_01/stin_st_003_cbisdd_stsrptmsg"
...
func Conv(in *stin_st_003_cbisdd_stsrptmsg.Document, opts ...ConvOption) ([]*pain_002_001_10.Document, error) {

	const semLogContext = "stin_st_003_cbi-sdd-stsrptmsg-to-pain-002-001-10::conv"
...
func XMLDataConv(stinData []byte, opts ...ConvOption) ([][]byte, error) {
	...
	const semLogContext = "stin-st-003-cbi-sdd-stsrptmsg-to-pain-002-001-10::xml-data-conv"
...
func XMLFileConv(inFn string, outFn string, opts ...ConvOption) ([]string, error) {
	...
	const semLogContext = "stin-st-003-cbi-sdd-stsrptmsg-to-pain-002-001-10::xml-file-conv"
